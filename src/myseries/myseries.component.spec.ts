...
// Mock component
@Component({
  selector: 'app-mock-myseries',
  template: '',
})
class MockEventComponent {/*...*/}

@Component({
  template: '<app-mock-myseries></app-mock-myseries>', // Use the correct selector
})
...
describe('EventComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [MyseriesComponent], // Move EventComponent to imports
