...
import { PreLoginComponent } from 'src/pre-login/pre-login.component';
...
export const appRoutes: Route[] = [
  ...
  { path: 'myevents', component: MyEventsComponent, canActivate: [AuthGuard, RoleGuard] },
  { path: 'createevent', component: CreateEventComponent, canActivate: [AuthGuard, RoleGuard] },
  { path: 'updateevent/:id', component: UpdateEventComponent, canActivate: [AuthGuard, RoleGuard] },
  { path: 'deleteevent/:id', component: DeleteEventComponent, canActivate: [AuthGuard, RoleGuard] },
  { path: 'socialclub/:id', component: SocialClubComponent, canActivate: [AuthGuard] },
  { path: 'help', component: HelpComponent, canActivate: [AuthGuard] },
  { path: 'oauth', component: OauthComponent },
  { path: 'hostcheckin', component: HostCheckinComponent, canActivate: [AuthGuard, RoleGuard] },
  { path: 'hostcheckin/:eventId', component: HostCheckinComponent, canActivate: [AuthGuard, RoleGuard] },
  { path: 'socialclublisting', component: SocialClubListingComponent, canActivate: [AuthGuard, RoleGuard] },
  { path: 'socialclubcreate', component: SocialClubCreateComponent, canActivate: [AuthGuard, RoleGuard] },
  { path: 'updatesocialclub/:id', component: UpdateSocialClubComponent, canActivate: [AuthGuard, RoleGuard] },
  { path: 'deletesocialclub/:id', component: DeleteSocialClubComponent, canActivate: [AuthGuard, RoleGuard] },
  ...
  { path: 'myseries', component: MyseriesComponent, canActivate: [AuthGuard, RoleGuard] },
  { path: 'myschedule', component: MyScheduleComponent, canActivate: [AuthGuard] },
  { path: 'updateseries/:id', component: UpdateSeriesComponent, canActivate: [AuthGuard, RoleGuard] },
  { path: 'deleteseries/:id', component: DeleteSeriesComponent, canActivate: [AuthGuard, RoleGuard] },
  { path: 'createseries', component: CreateSeriesComponent, canActivate: [AuthGuard, RoleGuard, RoleGuard] },
  ...
  { path: 'home', component: PreLoginComponent}
];