...
// Mock component
@Component({
  selector: 'app-mock-update-series',
  template: '',
})
class MockEventComponent {/*...*/}

@Component({
  template: '<app-mock-update-series></app-mock-update-series>', // Use the correct selector
})
...
describe('EventComponent', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [UpdateSeriesComponent], // Move EventComponent to imports
