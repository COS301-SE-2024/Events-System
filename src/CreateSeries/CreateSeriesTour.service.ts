...
export class CreateSeriesTourService {
    public fillSeriesName = new EventEmitter<string>();
    ...
    steps: [
      { 
        popover: { 
          ...
          description: 'This page is where the magic happens! to get started we\'ll name the series',
      ...
      { 
        ...
        popover: { 
          ...
          onNextClick:() => {
            this.fillDescriptionName.emit('This is a new description for a sample series name');
            this.eventdriverObj.moveNext();
          }
        } 
      },
